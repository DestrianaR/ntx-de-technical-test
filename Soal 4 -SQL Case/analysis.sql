...
-- However, only two users have non-null values in the avgSessionQualityDim column, 
-- indicating that only these two users had high session quality (i.e., were very close to making a transaction). 
